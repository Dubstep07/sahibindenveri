...
rf_params = {"max_depth": [2,5,8,10],"max_features": [2,5,8],"min_samples_split": [2,5,10]}
...
rf_tuned = DecisionTreeClassifier(max_depth = 2,max_features = 2,min_samples_split = 2)
